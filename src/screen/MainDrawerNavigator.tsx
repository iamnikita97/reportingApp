...
const HomeStack: React.FC<{navigation: DrawerNavigationProp<any>}> = ({
  navigation,
}) => (
  <Stack.Navigator
    screenOptions={{
...
const UserDetailsStack: React.FC<{navigation: DrawerNavigationProp<any>}> = ({
  navigation,
}) => (
  <Stack.Navigator
    screenOptions={{
...
const CustomerStack: React.FC<{navigation: DrawerNavigationProp<any>}> = ({
  navigation,
}) => (
  <Stack.Navigator
    screenOptions={{
